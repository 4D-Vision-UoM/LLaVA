...
def main():
    ...
    vqa_path = os.path.join(script_dir, "data/gemini-flash/sample-set")
    ...
    ####################################################################################
    output_dir = os.path.join(script_dir, "checkpoints/HumanML_MoPa_sampleset_10epoch_with_val_fix")
