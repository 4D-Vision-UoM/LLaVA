...
def main():
    ...
    ####################################################################################
    # Path to pretrained 4D motion encoder checkpoint (psttransformer)
    ####################################################################################
    psttransformer_checkpoint = os.path.join(script_dir, "pst_transformer_module/ckpt/HumanML_MoPa_psttransformer_batch_72")
    ...
    ####################################################################################
    output_dir = os.path.join(script_dir, "checkpoints/HumanML_PSTTransformer_finetuned_gemini_10epoch")
    
    # Ensure output directory exists
    os.makedirs(output_dir, exist_ok=True)
    
    print("=" * 80)
    print("LLaVA Training with PSTTransformer Encoder")
    print("=" * 80)
    print(f"PSTTransformer checkpoint: {psttransformer_checkpoint}")
    ...
    training_args = [
        ...
        # Path to pretrained 4D motion encoder checkpoint (PSTTransformer)
        ####################################################################################
        # *** KEY: Use PSTTransformer motion encoder ***
        "--vision_tower", psttransformer_checkpoint,
    ...
    print("\nStarting training with PSTTransformer motion encoder...")
    print("=" * 80)
