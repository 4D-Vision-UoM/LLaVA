...
from p4transformer_module.models import P4Transformer
...
class P4TransformerVisionTower(nn.Module):
    ...
    def __init__(self, vision_tower, args, delay_load=False):
        """
        Args:
            vision_tower: str, path to checkpoint directory (e.g., "P4Transformer/ckpt/HumanML_P4Transformer_32_frames_64batch")
