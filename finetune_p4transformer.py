...
def main():
    ...
    ####################################################################################
    # Path to pretrained 4D motion encoder checkpoint (p4transformer)
    ####################################################################################
    p4transformer_checkpoint = os.path.join(script_dir, "p4transformer_module/ckpt/HumanML_MoPa_p4transformer_batch72")
    ...
    ####################################################################################
    output_dir = os.path.join(script_dir, "checkpoints/HumanML_P4Transformer_finetuned_gemini_10epoch")
    
    # Ensure output directory exists
    os.makedirs(output_dir, exist_ok=True)
    
    print("=" * 80)
    print("LLaVA Training with P4Transformer Encoder")
    print("=" * 80)
    print(f"P4Transformer checkpoint: {p4transformer_checkpoint}")
    ...
    training_args = [
        ...
        # Path to pretrained 4D motion encoder checkpoint (P4Transformer)
        ####################################################################################
        # *** KEY: Use P4Transformer motion encoder ***
        "--vision_tower", p4transformer_checkpoint,
    ...
    print("\nStarting training with P4Transformer motion encoder...")
    print("=" * 80)
